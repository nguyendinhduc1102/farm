    ...
    */
    ...
    public function savecategory(Request $request)
    {
        ...
        if (!$checkcat) {
            ...
            $category->save();    
            return redirect('/addcategory')->with('status','The '.$category->category_name.' has been saved successfully');
        }else {
    ...
    public function deletecategory($id)
    {
        $category = Category::find($id);
        $category->delete();
        return redirect('/categories')->with('status','The '.$category->category_name.' category has been
